  ...
  return (
    <div className="text-center">
      ...
      <p className="text-gray-300 text-2xl mb-8 max-w-2xl mx-auto">
        Three mysterious boxes appear before you. Each contains questions from a
        different era. Choose wisely, time travelers!
      </p>
            ...
            <div key={boxIndex} className="flex flex-col items-center">
              ...
              >
                {!isRevealed ? (
                  ...
                  /* Revealed box */
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${boxContent!.color} rounded-lg border-4 border-yellow-400 flex flex-col items-center justify-center text-white animate-pulse`}
                  >
